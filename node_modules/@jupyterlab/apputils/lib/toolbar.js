...
export function ToolbarButtonComponent(props) {
    ...
    return (React.createElement(Button, { className: props.className
        ...
        props.iconClassName && (React.createElement(DefaultIconReact, { name: `${props.iconClassName} jp-Icon jp-Icon-16`, className: 'jp-ToolbarButtonComponent-icon', fallback: true, center: true, kind: 'toolbarButton', tag: 'span' })),
