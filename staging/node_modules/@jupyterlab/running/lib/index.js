...
function Item(props) {
    ...
    return (React.createElement("li", { className: ITEM_CLASS },
        React.createElement("span", { className: `${ITEM_ICON_CLASS} ${runningItem.iconClass()}` }),
        ...
        React.createElement(React.Fragment, null,
            React.createElement("header", { className: SECTION_HEADER_CLASS },
                React.createElement("h2", null,
                    props.manager.name,
                    " Sessions"),
                React.createElement(ToolbarButtonComponent, { tooltip: `Shut Down All ${props.manager.name} Sessions…`, iconClassName: "jp-CloseIcon jp-Icon jp-Icon-16", onClick: onShutdown })),
...
function RunningSessionsComponent(props) {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: HEADER_CLASS },
            React.createElement(ToolbarButtonComponent, { tooltip: "Refresh List", iconClassName: "jp-RefreshIcon jp-Icon jp-Icon-16", onClick: () => props.managers.items().forEach(manager => manager.refreshRunning()) })),
