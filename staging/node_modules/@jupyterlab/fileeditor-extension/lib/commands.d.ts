 ...
 */
export declare const EDITOR_ICON_CLASS = "jp-MaterialIcon jp-TextEditorIcon";
/**
 * The class name for the text editor icon from the default theme.
 */
export declare const MARKDOWN_ICON_CLASS = "jp-MarkdownIcon";
/**
...
export declare namespace Commands {
     ...
     */
    function addCommands(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string, isEnabled: () => boolean, tracker: WidgetTracker<IDocumentWidget<FileEditor>>, browserFactory: IFileBrowserFactory): void;
    /**
     * Add a command to change font size for File Editor
     */
    function addChangeFontSizeCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string): void;
    /**
     * Add the Line Numbers command
     */
    function addLineNumbersCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string, isEnabled: () => boolean): void;
    /**
     * Add the Word Wrap command
     */
    function addWordWrapCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string, isEnabled: () => boolean): void;
    /**
     * Add command for changing tabs size or type in File Editor
     */
    function addChangeTabsCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string): void;
    /**
     * Add the Match Brackets command
     */
    function addMatchBracketsCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string, isEnabled: () => boolean): void;
    /**
     * Add the Auto Close Brackets for Text Editor command
     */
    function addAutoClosingBracketsCommand(commands: CommandRegistry, config: CodeEditor.IConfig, settingRegistry: ISettingRegistry, id: string): void;
    /**
     ...
     */
    function addMenuItems(menu: IMainMenu, commands: CommandRegistry, tracker: WidgetTracker<IDocumentWidget<FileEditor>>, consoleTracker: IConsoleTracker): void;
    /**
     ...
     */
    function addCodeRunnersToRunMenu(menu: IMainMenu, commands: CommandRegistry, tracker: WidgetTracker<IDocumentWidget<FileEditor>>, consoleTracker: IConsoleTracker): void;
    /**
