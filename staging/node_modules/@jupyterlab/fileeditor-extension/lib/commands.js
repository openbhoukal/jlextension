...
(function (Commands) {
     ...
     */
    function addCommands(commands, config, settingRegistry, id, isEnabled, tracker, browserFactory) {
     ...
     */
    function addChangeFontSizeCommand(commands, config, settingRegistry, id) {
     ...
     */
    function addLineNumbersCommand(commands, config, settingRegistry, id, isEnabled) {
     ...
     */
    function addWordWrapCommand(commands, config, settingRegistry, id, isEnabled) {
     ...
     */
    function addChangeTabsCommand(commands, config, settingRegistry, id) {
     ...
     */
    function addMatchBracketsCommand(commands, config, settingRegistry, id, isEnabled) {
     ...
     */
    function addAutoClosingBracketsCommand(commands, config, settingRegistry, id) {
